...
def emprendedorEmprendimiento():
    ...
    return render_template("emprendedor-emprendimiento.html", emp)


@app.route("/emprendedor/ferias")
@login_required
def emprendedorFerias():
    return render_template("emprendedor-ferias.html")


#######################################cliente####################################################

@app.route("/cliente/emprendimiento")
@login_required
def clienteEmprendimiento():
    return render_template("cliente-emprendimiento.html")


@app.route("/cliente/ferias")
@login_required
def clienteFerias():
    return render_template("cliente-ferias.html")
...
def adminFeriaEditarDireccion():
    id_feria = request.args.get('idFeria')
    direccion = request.args.get('direccion')
